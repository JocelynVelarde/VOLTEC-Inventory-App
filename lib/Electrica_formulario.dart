...
class run_2 extends StatefulWidget {
  const run_2({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _run_2 createState() => _run_2();
}

// ignore: camel_case_types
class _run_2 extends State<run_2> {
  ...
  void _submitForm() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      FeedbackForm_2 feedbackForm_2 = FeedbackForm_2(
          nameController.text,
      ...
      formController.submitForm(feedbackForm_2, (String response) {
        // ignore: avoid_print
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Formulario Electrica"),
          actions: [
            IconButton(
                ...
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FeedbackListPage_2(
                              title: '',
                            ),
                          ));
                    },
