...
class run_7 extends StatefulWidget {
  const run_7({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _run_7 createState() => _run_7();
}

// ignore: camel_case_types
class _run_7 extends State<run_7> {
  ...
  void _submitForm() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      FeedbackForm_7 feedbackForm_7 = FeedbackForm_7(
          nameController.text,
      ...
      formController.submitForm(feedbackForm_7, (String? response) {
        // ignore: avoid_print
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Formulario NXT"),
          actions: [
            IconButton(
                ...
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const FeedbackListPage_7(
                              title: '',
                            ),
                          ));
                    },
