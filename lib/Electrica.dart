...
import 'Electrica_controller.dart';

class FeedbackListScreen_2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: const FeedbackListPage_2(title: "Inventario Herramientas"));
  }
}
...
class FeedbackListPage_2 extends StatefulWidget {
  ...
  _FeedbackListPageState_2 createState() => _FeedbackListPageState_2();
}

class _FeedbackListPageState_2 extends State<FeedbackListPage_2> {
  // ignore: deprecated_member_use, prefer_collection_literals
  List<FeedbackForm_2> feedbackItems = <FeedbackForm_2>[];
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => const run_2()));
                  },
                  child: const Icon(
                    Icons.add,
                    size: 26.0,
